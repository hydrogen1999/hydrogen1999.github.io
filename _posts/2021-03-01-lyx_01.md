...
1. Sau khi tải về, nhấn đúp vào file iso và chạy file ***install-tl-windows.bat*** dưới quyền administrator (chuột phải vào file ấy, chọn Run as administrator – bước quan trọng).<p align="center"><img width="500px" height="350px" src="image/texlive_install.png"></p>

1. Chờ đợi trình cài đặt tự động thực hiện (khoảng 15-20 phút tùy cấu hình máy).
